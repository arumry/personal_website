...
export default function Services() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`w-[320px] h-fit sm:h-60 flex flex-col justify-evenly bg-primary shadow-card rounded px-6 py-4 text-white transition-all duration-1000 ${
        ...
        <div
          className={`w-[320px] h-fit sm:h-60 flex flex-col justify-evenly bg-primary shadow-card rounded px-6 py-4 text-white mt-6 transition-all delay-300 duration-1000 ${
            Viewing ? "opacity-1 translate-y-0" : "opacity-0 translate-y-52"
          }`}
        >
        ...
        <div
          className={`w-[320px] h-fit sm:h-60 flex flex-col justify-evenly bg-primary shadow-card rounded px-6 py-4 text-white transition-all duration-1000 delay-700 ${
            Viewing ? "opacity-1 translate-y-0" : "opacity-0 translate-y-52"
          }`}
        >
          <div className="flex gap-3 justify-center items-center -ml-8">
